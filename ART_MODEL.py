...
gdal.AllRegister()
fn      ='J:\\2014MOD09GA006\\reflectance\\A2014001_reflectance_Grid_2D.img'
...
blockSize  = utils.GetBlockSize(band1)
...
# lon_nc,lat_nc = np.meshgrid(lon_nc,lat_nc)yBlockSize
...
bdata = band.ReadAsArray(j, i, numCols, numRows)
#*******************************************************************************
# ;+
# ;project:ART积雪反照率模型
# ;author:shaodonghang
