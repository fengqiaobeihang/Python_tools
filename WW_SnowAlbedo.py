...
g     =  0.549285
########################
solar_zenith_angle  =0.7828     #4-15:0.7828 4-16:0.8373 4-17:0.8405 4-18:0.8438
########################
g1 = g/(1+g)
w1 = ((1-g**2)*w)/(1-w*g**2)
# t = (1-w1*g**2)*t1
...
s  = (3*a1*(1-w1))**0.5
P  = (2*s)/(3*a1)
as_semi_albedo=(w1*(1-solar_zenith_angle*b*s))/((1+P)*(1+solar_zenith_angle*s))
print 'as_semi_albedo=',as_semi_albedo
# y = (1-A)/(1+A)
# Q1= (y+P)*exp(s*t)
# Q2= (y-P)*exp(-s*t)
# Q = (1+P)*Q1-(1-P)*Q2
